...
int main() {
    ...
    // 示例输入
    // std::vector<int> hand_range_r = {255, 255, 255, 255, 255, 255, 255, 255, 255, 255};
    // std::vector<int> hand_range_r = {255, 255, 255, 0, 255, 255, 0, 255, 0, 255};
    std::vector<int> hand_range_r = {255, 255, 255, 0, 255, 0, 0, 0, 0, 255};
    
    // std::vector<int> hand_range_l = {255, 255, 255, 255, 255, 255, 255, 255, 255, 255};
    // std::vector<int> hand_range_l = {128, 128, 128, 128, 128, 128, 128, 128, 128, 128};
	// std::vector<int> hand_range_l = {255, 255, 255, 0, 255, 255, 0, 255, 0, 255};
    std::vector<int> hand_range_l = {255, 255, 255, 0, 255, 0, 0, 0, 0, 255};
    ...
    // 测试右手弧度到范围
    std::vector<int> hand_range_r_back = arc_to_range_right_10(hand_arc_r);
    std::cout << "Right hand arc to range: ";
    for (int val : hand_range_r_back) {
        std::cout << val << " ";
    }
    std::cout << std::endl;

    // 测试左手弧度到范围
    std::vector<int> hand_range_l_back = arc_to_range_left_10(hand_arc_l);
    std::cout << "Left hand arc to range: ";
    for (int val : hand_range_l_back) {
        std::cout << val << " ";
    }
    std::cout << std::endl;
